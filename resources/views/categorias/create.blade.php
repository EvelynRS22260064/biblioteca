...
@section('page-description', 'Crea una nueva categoría para los libros del bosque')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8 relative">
            ...
            <p class="text-[#2d5a36] text-base max-w-3xl leading-relaxed">
                Crea una nueva categoría para los libros del bosque encantado
            </p>
        </div>
        ...
        <div class="form-card overflow-hidden max-w-2xl mx-auto">
            <div class="p-6 border-b border-[#99bF8c]">
                ...
                <p class="text-[#34633e] text-sm">Completa los campos para agregar una nueva categoría al catálogo</p>
            </div>
