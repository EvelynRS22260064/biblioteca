...
<head>
    ...
    <title>Crear Libro - Biblioteca del Bosque Encantado</title>
    ...
    <div class="container mx-auto px-4 py-12 max-w-3xl relative">
        ...
        <div class="mb-8 relative">
            ...
            <p class="text-[#2d5a36] text-lg max-w-2xl leading-relaxed pl-2">
                Añade un nuevo ejemplar al catálogo del bosque encantado
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nombre" class="form-input" placeholder="Ej. Cien años de soledad" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="isbn" class="form-input" placeholder="978-0307474728" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="autor" class="form-input" placeholder="Gabriel García Márquez" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="editorial" class="form-input" placeholder="Editorial Sudamericana" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="categoria_id" class="form-input appearance-none bg-white" required>
                    ...
                    {{-- Campo: Fecha de Publicación (condicional) --}}
                    @if(isset($campos['publicacion']))
                    <div>
                        <label class="form-label flex items-center gap-2">
                        ...
                        <div class="relative">
                            <i class="fa-solid fa-calendar-days absolute left-4 top-1/2 -translate-y-1/2 text-[#5b8c5a]"></i>
                            <input type="date" name="publicacion" class="form-input">
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-sm text-[#8bb682] italic font-story">
                ...
                Cada libro es una puerta a un nuevo mundo
